...
const PostJob = () => {
  ...
  //           <div className="mb-4">
  //             <label className="block text-sm font-medium text-gray-700 mb-2">Company Motto</label>
  //             <input
  //               type="text"
  //               value={companyMotto}
  ...
  //           <div className="mb-4">
  //             <label className="block text-sm font-medium text-gray-700 mb-2">Count of Employees</label>
  //             <input
  //               type="text"
  //               value={employeeCount}
