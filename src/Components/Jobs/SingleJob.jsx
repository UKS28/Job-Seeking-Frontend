...
const SingleJob = () => {
  ...
  const getAllreadyApplied = async () => {
    try {
      const { data } = await axios.get(
        `https://job-seeking-backend-e4fu.onrender.com/api/v1/applications//applicant/application/${jobId}`,
        ...
        <div className="mt-28 container mx-auto p-4 space-y-6">
          <div className="p-6 border-b border-gray-200">
            <h1 className="text-2xl font-bold mb-2">
              {job.role} ({job.experience}+ years experience)
            </h1>
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="flex space-x-4">
              <span className="bg-gray-200 text-gray-800 py-1 px-3 rounded">
                {job.location}
              </span>
              <span className="bg-gray-200 text-gray-800 py-1 px-3 rounded">
                Employee count: {job.employeeCount}
              </span>
              <span className="bg-gray-200 text-gray-800 py-1 px-3 rounded">
                Private Company
              </span>
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="mb-2">
              <strong>Skills Required:</strong> {job.skill}
            </p>
          </div>
