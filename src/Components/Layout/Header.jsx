...
const handleLogout=async (e)=>{
  ...
  return (
    ...
    <div className='flex justify-between items-center mx-6   '>
        {/* 1.logo */}
         <div className='flex'>
            <div className="font-bold text-center h-15 w-33 flex items-center justify-center text-2xl">Job Seeking</div>
        ...
        <div className='flex space-x-4'>
            <NavLink 
                to="/" 
                className={({ isActive }) => 
                    `text-lg transition duration-300 ease-in-out ${isActive ? 'underline text-blue-500' : 'text-black hover:text-red-500 hover:underline hover:shadow-md'}`
                }
            >
                Home
            </NavLink>
